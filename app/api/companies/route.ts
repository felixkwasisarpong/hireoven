  ...
  try {
    ...
    const result = await pool.query<Record<string, unknown> & { total_count: string }>(
      `SELECT
         ...
         companies.ats_type,
         companies.ats_identifier,
         companies.is_active,
         companies.last_crawled_at,
         companies.job_count,
         companies.notes,
         companies.h1b_sponsor_count_1yr,
         companies.h1b_sponsor_count_3yr,
         companies.sponsors_h1b,
         companies.sponsorship_confidence,
         companies.immigration_profile_summary,
         companies.hiring_health,
