...
import type { AutofillHistoryEntry } from "@/lib/autofill/history"

type AutofillHistoryStats = {
  totalApplications: number
  avgFillRate: number
  minutesSaved: number
}

type AutofillHistoryPageClientProps = {
  initialHistory?: AutofillHistoryEntry[]
  initialStats?: AutofillHistoryStats
...
function HistoryRow({ entry }: { entry: AutofillHistoryEntry }) {
...
const EMPTY_STATS: AutofillHistoryStats = {
  totalApplications: 0,
  avgFillRate: 0,
  minutesSaved: 0,
}

export default function AutofillHistoryPageClient({
  initialHistory = [],
  initialStats = EMPTY_STATS,
  initialLoaded = false,
}: AutofillHistoryPageClientProps) {
  const [history, setHistory] = useState<AutofillHistoryEntry[]>(initialHistory)
  const [stats, setStats] = useState<AutofillHistoryStats>(initialStats)
