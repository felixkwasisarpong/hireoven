...
export default async function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#0f1115_0%,#171A1F_12%,#EEF2F7_12%,#F5F7FB_100%)]">
      <div className="grid min-h-screen lg:grid-cols-[280px_minmax(0,1fr)]">
        ...
        <div className="min-w-0">
          <header className="sticky top-0 z-30 border-b border-slate-200 bg-white px-5 py-4 shadow-[0_10px_24px_rgba(15,23,42,0.08)]">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex min-w-0 items-start gap-3">
                <Link
                  href="/admin"
                  className="mt-0.5 shrink-0 rounded-xl border border-gray-200 bg-white p-1.5 shadow-sm transition hover:border-gray-300 hover:bg-gray-50"
                  aria-label="Admin home"
                >
                  <HireovenLogo variant="mark" className="h-9 w-9" />
                </Link>
                <div className="min-w-0">
                  <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-gray-600">
                    Hireoven Admin
                  </p>
