...
export default function DashboardHeader() {
  ...
  return (
    <header className="dash-header-bar">
      <div className="mx-auto flex max-w-[1680px] flex-col gap-3 px-4 py-3 md:flex-row md:items-center md:gap-4 lg:px-6">
        <div className="flex min-w-0 shrink-0 items-center justify-between gap-3 md:w-[220px] md:justify-start lg:w-[240px]">
          <Link
            href="/dashboard"
