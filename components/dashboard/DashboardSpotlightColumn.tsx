...
const THEME = {
  ...
  blue: {
    ...
    glow1:   "from-blue-400/35 to-indigo-300/25",
    glow2:   "from-violet-500/20 to-blue-400/15",
    badge:   "from-blue-500 to-indigo-600",
    icon:    "from-blue-500 to-indigo-600 shadow-blue-500/35",
    title:   "from-blue-950 via-indigo-900 to-blue-950",
    cta:     "from-blue-600 to-indigo-600 shadow-[0_10px_24px_-8px_rgba(37,99,235,0.45)] ring-blue-400/80 hover:shadow-[0_12px_28px_-8px_rgba(37,99,235,0.55)]",
    bg:      "from-[#EFF6FF] via-blue-50 to-indigo-50",
  },
  green: {
