  ...
  return (
    <div className="rounded-xl border border-slate-100 bg-white p-3.5 shadow-[0_1px_4px_rgba(15,23,42,0.06)] transition hover:shadow-[0_2px_8px_rgba(15,23,42,0.10)]">
      <div className="flex items-start justify-between gap-3">
        {/* Avatar placeholder */}
        <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-orange-400 to-orange-500 text-[13px] font-bold text-white">
