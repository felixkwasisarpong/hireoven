...
function InlinePrompt({ feature }: { feature: FeatureKey }) {
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-4 shadow-[0_2px_12px_rgba(15,23,42,0.06)]">
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-[#FF5C18] via-[#FF9A3C] to-orange-500" />

      <div className="flex items-center gap-3.5">
        {/* Icon */}
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#FF5C18]/10 to-orange-500/10 ring-1 ring-[#FF5C18]/20">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-0.5 flex items-center gap-1.5">
            <span className="inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-[#FF5C18]/10 to-orange-500/10 px-2 py-0.5 text-[10.5px] font-bold uppercase tracking-wide text-[#FF5C18]">
...
function BannerPrompt({ feature }: { feature: FeatureKey }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-[#FF5C18]/20 bg-gradient-to-r from-[#FFF4EE] to-[#FFF8F5] px-4 py-2.5">
      <div className="pointer-events-none absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-orange-50/40 to-transparent" />
    ...
    <div className="relative isolate overflow-hidden rounded-2xl">
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-white/40 backdrop-blur-[2px]">
        ...
        <div className="relative mx-4 w-full max-w-[280px] overflow-hidden rounded-2xl border border-white/80 bg-white/95 px-6 py-5 text-center shadow-[0_16px_48px_rgba(15,23,42,0.14)] backdrop-blur-md">
          {/* Top gradient bar */}
          <div className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-[#FF5C18] via-[#FF9A3C] to-orange-500" />
          ...
          {/* Plan badge */}
          <span className="inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-[#FF5C18]/10 to-orange-500/10 px-2.5 py-0.5 text-[10.5px] font-bold uppercase tracking-wider text-[#FF5C18] ring-1 ring-[#FF5C18]/20">
            <Sparkles className="h-2.5 w-2.5" />
            {planLabel} feature
          </span>
