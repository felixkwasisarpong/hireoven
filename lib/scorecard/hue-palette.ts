...
export const HUE_PALETTE: Record<ScoreHue, HuePalette> = {
  ...
  lime: { ring: "#84cc16", soft: "#f7fee7", softer: "#fefce8", text: "text-lime-700", bar: "bg-lime-500", softDark: "rgba(132,204,22,0.14)", textDark: "text-lime-300" },
...
export function paletteFor(hue: ScoreHue): HuePalette {
  return HUE_PALETTE[hue] ?? HUE_PALETTE.amber
}
