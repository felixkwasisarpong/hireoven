...
import type { ApexInterviewSession } from "./types"

const KEY     = "hireoven:apex:interview:v1"
const MAX_AGE = 7 * 24 * 60 * 60 * 1000   // 7 days

type Store = {
  v:        1
  session:  ApexInterviewSession
  savedAt:  number
}

export function readInterviewSession(): ApexInterviewSession | null {
...
export function writeInterviewSession(session: ApexInterviewSession): void {
